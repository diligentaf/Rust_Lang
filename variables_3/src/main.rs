...
fn main() {
    ...
    //  == Looping through array (not a good practice) == 
    println!();
    println!("== Looping through array (not a good practice) ==");
    ...
    //  == Looping through array (better practice) == 
    println!();
    println!("== Looping through array (better practice) ==");
    let a = [10, 20, 30, 40, 99];
    for element in a {
        println!("the value is : {element}")
    }

    // Looping in reverse using rev
    println!();
    println!("== Looping in reverse using rev ==");
